	...
	if(empty($firstname) || empty($lastname) || empty($middlename) || empty($age) || empty($gender) || empty($email) || empty($password) || empty($c_password) || empty($mobile_num) || empty($address)) {
		...
		if($check_email > 0) {
        	...
        	if($file_name == '') {
	        	...
	        	$sql 	= "INSERT INTO `user`(`id`, `acc_id`, `user_firstname`, `user_middlename`, `user_lastname`, `user_age`, `user_gender`, `user_mobile`, `user_address`) VALUES (NULL,'$acc_id','$firstname','$middlename','$lastname','$age','$gender','$mobile_num','$address')";
	        	$qry 	= mysqli_query($con, $sql);

	        	$_SESSION['msg'] = "<div class='alert alert-success'><a href='#' class='close'>&times</a>Yeeeyyyyy, Successfully Register...</div>";
	        }
	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			...
			<div class="col-md-10 display-table-cell valign-top box">
				...
				<div id="content">
					<header>
						<h2 class="page-title"><span class="fa fa-user"></span> New User</h2>
					</header>
