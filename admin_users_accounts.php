    	...
    	$(document).ready(function(){
    		$('.delete_data').click(function(){
				...
				if(confirm('WARNING: Are you sure you want to delete this?')) {
					...
					window.location = 'delete.php?user_account_id='+id;
				}
				else {
    		...
    		$('.delete_all_users_account').click(function(){
    			var acc_type = $(this).attr('id')
    			if(confirm('Are you sure you want to delete all data?')) {

    				window.location = 'delete.php?delete_all_users_account='+acc_type;
    			}
    			else {
	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			...
			<div class="col-md-10 display-table-cell valign-top box">
				...
				<div id="content">
					<header>
						<h2 class="page-title"><span class="fa fa-users"></span> Users Accounts</h2>
					</header>
					
						<div class="form-wrapper-accounts">
							
							<a href="signup.php" class="new-user" style="float: right; margin-left: 5px; margin-bottom: 5px;"><button class="btn-sm"><span class="fa fa-plus"></span> Register new user</button></a>
							<a href="#" id="user" class="delete-user delete_all_users_account" style="float: right;"><button class="btn-sm"><span class="fa fa-remove"></span> Delete all users accounts</button></a>
							...
							<table class="table table-style" style="background-color: #fff;">
								<thead>
									...
									<?php 
										...
										$sql = 'SELECT * FROM account WHERE acc_type = "user"';
										...
										if($num_rows > 0) { 
											...
											<tr>
												...
												<td><a href="edit_user_account.php?id=<?php echo $row['acc_id'] ?>"><button class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span> Edit</button></a>
