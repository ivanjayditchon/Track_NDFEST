...
if(isset($_POST['update'])) {
	...
	if(empty($email) || empty($password)) {
		...
		$_SESSION['msg'] = "<div class='alert alert-success'><a href='#' class='close'>&times</a>Yeeeyyyy, Account has been Successfully Updated..</div>";
    }
}
...
<html>
<head>
	<title>Update Admin Accounts</title>
	<meta charset="utf-8">
	...
	<div class="container-fluid display-table">
		<div class="row display-table-row">
			...
			<div class="col-md-10 display-table-cell valign-top box">
				...
				<div id="content">
					<header>
						<h2 class="page-title"><span class="fa fa-user"></span>Update Administrator</h2>
					</header>
