		...
		$(document).ready(function(){
			$('.delete_data').click(function(){
				...
				if(confirm("Are you sure you want to delete this?")) {
					...
					window.location = 'delete.php?user_id='+id+'&user_img='+img;
			...
			$('#delete_all_users_data').click(function(){
				if(confirm('Are you sure you want to delete all the users data?')) {

					window.location = 'delete.php?delete_all_users';
				}
				...
				<div id="content">
					<header>
						...
						<div class="form-wrapper-accounts">
							...
							<a href="admin_new_user.php" class="new-user" style="float: right; margin-left: 5px; margin-bottom: 5px;"><button class="btn-sm"><span class="fa fa-plus"></span> Register new user</button></a>
							<a href="#" class="delete-user" id="delete_all_users_data" style="float: right;"><button class="btn-sm"><span class="fa fa-remove"></span> Delete all users</button></a>
									...
									<?php 
										...
										if($num_rows > 0) { 
											...
											<tr>
												...
												<td style="padding-top: 20px;"><?php echo $row['user_firstname']; ?></td>
												<td style="padding-top: 20px;"><?php echo $row['user_middlename']; ?></td>
												<td style="padding-top: 20px;"><?php echo $row['user_lastname']; ?></td>
												<td style="padding-top: 20px;"><?php echo $row['user_age']; ?></td>
												<td style="padding-top: 20px;"><?php echo $row['user_gender']; ?></td>
												<td><img src="<?php echo "users_image/".$row['user_image']?>" width="50" height="50"></td>
												<td style="padding-top: 20px;"><?php echo $row['user_mobile']; ?></td>
												<td style="padding-top: 20px;"><?php echo $row['user_address']; ?></td>
												
												<td style="padding-top: 20px;"><a href="edit_users.php?id=<?php echo $row['acc_id']?>"><button class="btn btn-warning btn-sm"><span class="fa fa-pencil"></span> Edit</button></a>
												<a href="#" class="delete_data" img="<?php echo $row['user_image'] ?>" id="<?php echo $row['id']?>"><button class="btn btn-danger btn-sm"><span class="fa fa-trash"></span> Delete</button></a></td>
											</tr>
										<?php } 
										} 
